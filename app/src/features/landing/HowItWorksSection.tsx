...
const pickChallengeSteps = [
  {
    id: 1,
    name: 'Read the challenge description',
    description:
  ...
  {
    id: 2,
    name: 'Check the expected result',
    description: `We provide a reference demo that demonstrates the expected solution. It's fully interactive but without the source code. Your application should work in the same way.`,
    icon: GlobeAltIcon,
  },
  {
    id: 3,
      ...
      <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">
            We are trying to provide a perfect user experience similar to native
            IDEs.
          </p>
        </div>
