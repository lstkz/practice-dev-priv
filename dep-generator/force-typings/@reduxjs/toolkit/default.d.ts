 ...
 * @public
 */
export declare interface ActionCreatorWithNonInferrablePayload<
 ...
 * @public
 */
export declare interface ActionCreatorWithOptionalPayload<
  P,
  T extends string = string
 ...
 * @public
 */
export declare interface ActionCreatorWithoutPayload<T extends string = string>
 ...
 * @public
 */
export declare interface ActionCreatorWithPayload<P, T extends string = string>
  extends BaseActionCreator<P, T> {
  /**
   * Calling this {@link redux#ActionCreator} with an argument will
   * return a {@link PayloadAction} of type `T` with a payload of `P`
...
/** @public */
declare type ActionFromMatcher<M extends Matcher<any>> = M extends Matcher<
  infer T
>
  ? T
  : never;
...
declare type ActionsFromAsyncThunk<T extends AnyAsyncThunk> =
  | ActionFromMatcher<T['pending']>
  | ActionFromMatcher<T['fulfilled']>
  | ActionFromMatcher<T['rejected']>;

declare type AnyAsyncThunk = {
  pending: {
 ...
 * @public
 */
export declare type AsyncThunk<
  Returned,
  ThunkArg,
 ...
 * @public
 */
export declare type AsyncThunkAction<
  Returned,
  ThunkArg,
  ThunkApiConfig extends AsyncThunkConfig
> = (
 ...
 * @public
 */
export declare type AsyncThunkOptions<
  ThunkArg = void,
  ThunkApiConfig extends AsyncThunkConfig = {}
> = {
  /**
 ...
 * @internal
 */
declare type AtLeastTS35<True, False> = [True, False][IsUnknown<
  ReturnType<<T>() => T>,
  0,
  1
>];
 ...
 * @public
 */
export declare type CaseReducer<S = any, A extends Action = AnyAction> = (
  state: Draft<S>,
  action: A
) => S | void | Draft<S>;
 ...
 * @public
 */
export declare type ConfigureEnhancersCallback = (
 ...
 * @public
 */
export declare interface ConfigureStoreOptions<
  S = any,
  A extends Action = AnyAction,
 ...
 * @public
 */
export declare function createImmutableStateInvariantMiddleware(
 ...
 * @public
 */
export declare function createReducer<S>(
  initialState: S,
 ...
 * @public
 */
export declare function createSerializableStateInvariantMiddleware(
 ...
 */
declare type DispatchForMiddlewares<M> = M extends ReadonlyArray<any>
  ? UnionToIntersection<
 ...
 * @public
 */
export declare interface EnhancedStore<
  S = any,
  A extends Action = AnyAction,
  M extends Middlewares<S> = Middlewares<S>
> extends Store<S, A> {
 ...
 * @public
 */
export declare function findNonSerializableValue(
  value: unknown,
  path?: string,
...
declare type FulfilledActionFromAsyncThunk<T extends AnyAsyncThunk> =
  ActionFromMatcher<T['fulfilled']>;
 ...
 */
export declare function getDefaultMiddleware<
  S = any,
  O extends Partial<GetDefaultMiddlewareOptions> = {
    thunk: true;
    immutableCheck: true;
 ...
 * @internal
 */
declare type IfMaybeUndefined<P, True, False> = [undefined] extends [P]
  ? True
  : False;
 ...
 * @public
 */
export declare function isAllOf<
  Matchers extends [Matcher<any>, ...Matcher<any>[]]
>(
  ...matchers: Matchers
): (
 ...
 * @public
 */
export declare function isAnyOf<
  Matchers extends [Matcher<any>, ...Matcher<any>[]]
>(
  ...matchers: Matchers
 ...
 * @public
 */
export declare function isAsyncThunkAction(): (
  action: any
 ...
 * @internal
 */
declare type IsEmptyObj<T, True, False = never> = T extends any
 ...
 * @public
 */
export declare function isFulfilled(): (
  action: any
 ...
 * @public
 */
export declare function isRejected(): (
  action: any
 ...
 * @public
 */
export declare function isRejectedWithValue(): (
  action: any
) => action is UnknownAsyncThunkRejectedAction;
 ...
 * @internal
 */
declare type IsUnknown<T, True, False = never> = unknown extends T
  ? IsAny<T, False, True>
  : False;
 ...
 * @public
 */
export declare class MiddlewareArray<
...
declare type PendingActionFromAsyncThunk<T extends AnyAsyncThunk> =
  ActionFromMatcher<T['pending']>;
...
declare type RejectedActionFromAsyncThunk<T extends AnyAsyncThunk> =
  ActionFromMatcher<T['rejected']>;

declare type RejectedWithValueActionFromAsyncThunk<T extends AnyAsyncThunk> =
  ActionFromMatcher<T['rejected']> &
...
declare type UnknownAsyncThunkAction =
  | UnknownAsyncThunkPendingAction
  | UnknownAsyncThunkRejectedAction
  | UnknownAsyncThunkFulfilledAction;

declare type UnknownAsyncThunkFulfilledAction = ReturnType<
  AsyncThunkFulfilledActionCreator<unknown, unknown>
>;

declare type UnknownAsyncThunkPendingAction = ReturnType<
  AsyncThunkPendingActionCreator<unknown>
>;

declare type UnknownAsyncThunkRejectedAction = ReturnType<
...
declare type UnwrappedActionPayload<T extends UnwrappableAction> = Exclude<
  T,
  {
    error: any;
  }
 ...
 * @public
 */
export declare function unwrapResult<R extends UnwrappableAction>(
  action: R
 ...
 * @public
 */
export declare type ValidateSliceCaseReducers<
  S,
...
declare type WithStrictNullChecks<True, False> = undefined extends boolean
  ? False
  : True;
